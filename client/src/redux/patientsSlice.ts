...
const patientSlice = createSlice({
  ...
  extraReducers(builder) {
    ...
    builder.addCase(fetchAllPatients.fulfilled, (state, action) => { state.patients = action.payload });
...
export const { setPatients, clearPatient, setEditPatient, getPatientToUpdate } = patientSlice.actions;
